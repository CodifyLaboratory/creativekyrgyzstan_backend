        ...
        <Card.Text className="user__details">
          ...
          <ul className="social-icons">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              href={user.submit.facebook}
            >
              <FaFacebookSquare size={30} className="icons" />
            </a>
            <a target="_blank" rel="noreferrer" href={user.submit.telegram}>
              <FaTelegram size={30} className="icons" />
            </a>
            <a target="_blank" rel="noreferrer" href={user.submit.instagram}>
