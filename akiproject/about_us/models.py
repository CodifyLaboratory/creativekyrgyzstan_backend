...
class Founders(models.Model): 
    founder = models.OneToOneField(Submit, verbose_name='Выберите из Члены  АКИ или уже выбран чтобы посмотреть нажмите на карандаш', on_delete=models.SET_NULL, null=True)
