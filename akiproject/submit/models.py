...
class Submit(models.Model):
    ...
    facebook = models.CharField('Facebook', max_length=150, null= True, blank= True)
    telegram = models.CharField('Telegram', max_length=150, null= True, blank= True)
    whatsapp = models.CharField('WhatsApp', max_length=150, null= True, blank= True)
    instagram = models.CharField('instagram', max_length=150, null= True, blank= True)
    twitter = models.CharField('Twitter', max_length=150, null= True, blank= True)
    tiktok = models.CharField('TikTok', max_length=150, null= True, blank= True)
